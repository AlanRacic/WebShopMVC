...
namespace WebShopMVC.Areas.Admin.Controllers
{
    ...
    public class ProductCategoryController : Controller
    {
        ...
        public async Task<IActionResult> Index(int productId)
        {
            ...
            List<ProductCategory> list = await _context.ProductCategory.Where(p=>p.ProductId==productId).ToListAsync();
        ...
        public IActionResult Create(int productId)
        {
            if (productId == 0 || productId < 0)
                return RedirectToAction("Index", "Product");
            ViewBag.Categories = _context.Category.Select(cat => new SelectListItem 
            {
