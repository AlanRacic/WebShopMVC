...
namespace WebShopMVC.Areas.Admin.Controllers
{
    ...
    public class ImageController : Controller
    {
        ...
        public async Task<IActionResult> Index(int productId)
        {
            ...
            List<Image> images = await _context.Image.Where(i => i.ProductId == productId).ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,IsMain,Title,Description,URL,ProductId")] Image image, IFormFile file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("ProductId", "File in incorrect format! Must be jpg or jpeg or png!");
                    return View(image);
                }
