...
namespace WebShopMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult CreateOrder([Bind("Total,BillingFirstName,BillingLastName,BillingEmail,BillingPhone,BillingAddress,BillingCity,BillingZIP,BillingCountry," +
            "ShippingFirstName,ShippingLastName,ShippingEmail,ShippingPhone,ShippingAddress,ShippingCity,ShippingZIP,ShippingCountry,Message")] Order order, string ShippingSameAsBilling)
        {
        ...
        private string CheckCart()
        {
            ...
            for (int i = 0; i < cart.Count; i++)
            {
                ...
                { 
                    message += " The item " + cart[i].Product.Title + " had to be removed because of no stock!";
                    cart.RemoveAt(i);
                    i--;
                }
            }
